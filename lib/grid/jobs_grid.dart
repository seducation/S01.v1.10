...
class JobsGridWidget extends StatefulWidget {
  const JobsGridWidget({super.key});

  @override
  State<JobsGridWidget> createState() => _JobsGridWidgetState();
}

class _JobsGridWidgetState extends State<JobsGridWidget> {
  ...
  Future<List<real.Product>> _getProducts(AppwriteService service) async {
    try {
      ...
      debugPrint('Error fetching products for jobs: $e');
      return [];
    }
  }
