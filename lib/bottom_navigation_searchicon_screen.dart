...
class BottomNavigationSearchIconScreen extends StatefulWidget {
  const BottomNavigationSearchIconScreen({super.key});

  @override
  State<BottomNavigationSearchIconScreen> createState() => _BottomNavigationSearchIconScreenState();
}

class _BottomNavigationSearchIconScreenState extends State<BottomNavigationSearchIconScreen> {
